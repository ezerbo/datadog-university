...
export class EnrollmentsDialog extends React.Component<EnrollmentsProps, EnrollmentsState> {
                ...
                />
                {
                    selected && (
                        <GradeDialog
                            ...
                            onSelect={this.onGradeSelection}
                        />
                    )
                }
                {
    ...
    private toggleGradeSubmissionDialog = () => {
        this.setState((state) => {
            let selectedGrade = state.grade.grade !== MISSING_GRADE ? state.grade.grade : ''
            return {
                selectedGrade: selectedGrade,
    ...
    private onGradeSelection = (g: string) => {
        this.setState({selectedGrade: g});
    }
